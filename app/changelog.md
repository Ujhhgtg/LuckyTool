...
- [适配] 控制中心通知两侧对齐 C15.0.1

### 1.2.9

- [修复] 解锁页面底部SOS按钮Hook异常
- [修复] 检测更新对话框与布局显示逻辑
- [修复] 部分因适配RUI6导致的实例获取问题
- [添加] 自定义处理器介绍页面参数
- [更改] 重新添加响铃状态切换磁贴
...
- [添加] 通话隐私保护 C14
- [添加] 启用三方应用通话录音 C14
- [添加] 启用充电至80% 旁路充电模式 C13+
- [更改] 状态栏电池通知无线充电类型精简显示
- [优化] 优化快捷入口跳转方法逻辑
- [优化] 优化状态栏电池通知数据缓存以减少耗电
- [修复] 强制刷新率自启失效问题
- [优化] TileService命名格式(需重新添加磁贴)
- [优化] 状态栏电池通知无线充电技术显示
- [优化] 锁屏充电组件无线充电技术显示
- [修复] 部分机型状态栏通知背景透明度异常
- [优化] 优化相机自定义水印字数限制
...
- [修复] 模块底部导航栏动态取色异常
- [修复] 核心破解配置读取异常
- [优化] 更新对话框支持MarkDown语法
- [适配] 允许锁定/解锁已排除活动 C14
- [适配] 移除状态栏系统提示图标 C14
- [添加] 移除游戏助手工具推荐卡片
- [适配] 后台任务锁定数量 C14
- [修复] 解锁默认桌面限制Hook异常 C12.1
- [添加] 启用超级音量模式
- [添加] 启用通话超级音量模式
- [添加] 锁屏充电组件显示实际充电技术
- [添加] 移除日历节假日页面信息流
...
- [修复] 状态栏电池字体大小Hook异常 C14
- [修复] 状态栏磁贴扩展行数判定逻辑 C14
- [更改] 自动扩展横屏磁贴行数仅在C14生效
- [适配] 移除锁屏底部按钮 C14
- [修复] 点击通知无法显示USB连接对话框 C14
- [适配] 状态栏电池图标百分号 C14
- [适配] 同步上游核心破解 C14
- [添加] 启用自定义应用语言 C14
- [适配] 锁屏开关手电筒自动息屏 C14
