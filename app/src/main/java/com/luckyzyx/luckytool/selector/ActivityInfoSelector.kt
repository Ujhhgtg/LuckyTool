...
//        setCancelable(false)
        ...
        scope {
            ...
            binding.recyclerView.apply {
                singleSelectorAdapter = ActivityInfoSingleSelectorAdapter(
                    dialog, allActivityInfos, onSelectActivityInfoListener
                )
                multiSelectorAdapter =
                    ActivityInfoMultiSelectorAdapter(dialog, allActivityInfos, allEnableInfos)
    ...
    @Obfuscate
    class ActivityInfoSingleSelectorAdapter(
        private val dialog: AlertDialog?,
        allAppInfos: ArrayList<ActivityInfo>,
        private val onSelectActivityInfoListener: OnSelectActivityInfoListener?
    ) : RecyclerView.Adapter<SingleViewHolder>() {
        val context = dialog?.context

        private var allDatas = ArrayList<ActivityInfo>()
        ...
        override fun onBindViewHolder(holder: SingleViewHolder, position: Int) {
            ...
            val appIcon = if (context != null) activityInfo.loadIcon(context.packageManager)
            else null
            val label = if (context != null) activityInfo.loadLabel(context.packageManager)
            else null
    ...
    @Obfuscate
    class ActivityInfoMultiSelectorAdapter(
        dialog: AlertDialog?,
        allAppInfos: ArrayList<ActivityInfo>,
        allEnableInfos: ArrayList<ActivityInfo>
        ...
        private var enabledAppData = ArrayList<ActivityInfo>()
        ...
        override fun onBindViewHolder(holder: MultiViewHolder, position: Int) {
            ...
            holder.checkbox.isChecked = enabledAppData.contains(activityInfo)
            holder.activityInfoView.setOnClickListener {
                holder.checkbox.performClick()
            }
            holder.checkbox.setOnCheckedChangeListener { _, isChecked ->
                enabledAppData.remove(activityInfo)
                if (isChecked) enabledAppData.add(activityInfo)
            }
        }
